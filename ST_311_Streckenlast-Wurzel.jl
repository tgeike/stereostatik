...
# ╔═╡ 66eb4177-d397-49af-9707-cc7a73908a93
using Plots,QuadGK

# ╔═╡ 5d971b34-480f-11ef-36c0-b74cc08eb09e
md"""
## Aufgabe 1 
Die Aufgabenstellung findet sich im Abschnitt 3.3"""

# ╔═╡ 0e96185a-445c-4a31-9b81-f74f70fbe1b9
begin 
	q0 = 10.0 # kN/m
	L = 0.3 # m
end;

# ╔═╡ ac0f102b-9944-4502-a4de-aed6764eb10c
md"""
### Vorarbeit
In einem ersten Schritt stellen wir die Funktionsgleichung der Streckenlast auf. Die Streckenlast ist eine Wurzelfunktion, die bei ``x=0`` den Wert ``q_0`` hat und bei ``x=L`` den Wert Null.

Zur Erinnerung: Die Funktion `sqrt` bezeichnet die Quadratwurzel (Englisch: square root)."""

# ╔═╡ 12466170-ffd0-4076-8073-b34910ab0dd4
q(x) = q0*sqrt(1-x/L)

# ╔═╡ dac669ad-c245-407b-8fc5-6a166e1398d8
...
md"""
### Analytische Berechnung von resultierender Kraft und resultierendem Moment
Für die resultierende Kraft gilt 
```math
F_\mathrm{res} = \int_0^L q(x)\,\mathrm{d}x\;.
```
Für das resultierende Moment bezüglich des Koordinatenursprungs O gilt
```math
...
Fres_analyt = 2/3*q0*L

# ╔═╡ 15acd8b2-4cd4-41a7-90d5-427285bcd10f
md"""Die resultierende Kraft der Streckenlast im betrachteten Intervall ist $(round(Fres_analyt,digits=2)) kN."""
...
md"""
### Numerische Integration mit dem Paket `QuadGK`
...
md"""Numerische und analytische Ergebnisse für die resultierende Kraft und das resultierende Moment bezüglich O sind praktisch identisch."""

# ╔═╡ 8fe3a69d-21e7-4be5-8625-6e6c06970e48
md"""Wo liegt die Wirkungslinie der resultierenden Kraft? Die resultierende Kraft muss bezüglich O (wie für jeden anderen Bezugspunkt auch), das gleiche Moment erzeugen wie die Streckenlast. Demnach muss gelten
```math
M_\mathrm{res}^{(\mathrm{O})} = x_\mathrm{res}\, F_\mathrm{res} \;.
```
Daraus ergibt sich die ``x``-Koordinate der Wirkungslinie im gegebenen Koordinatensystem.
"""
...
md"""Die Wirkungslinie der resultierenden Kraft liegt $(round(xres,digits=3)) m vom Koordinatenursprung O entfernt. Die Länge $(round(xres,digits=3)) m entspricht $(round(xres/L*100,digits=1))% der Gesamtlänge des belasteten Bereichs (insgesamt $(round(L,digits=3)) m)."""
...
manifest_format = "2.0"
project_hash = "cc85a1d0690e995a50b1e91d124b6e68fb83467f"
